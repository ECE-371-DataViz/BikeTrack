...
def main():
    ...
    parser.add_argument(
        "--images", nargs="+", required=True, help="Image files to process"
    )
    parser.add_argument(
        "--center-lat", type=float, required=True, help="Center latitude"
    )
    parser.add_argument(
        "--center-lon", type=float, required=True, help="Center longitude"
    )
